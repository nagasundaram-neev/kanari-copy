...
var LocalyticsSession = function (appKey, options) {
  ...
  return (function (window, undefined) {
    ...
    var logFn = (function () {
      return (console && console.log) ? function (o) { console.log(o); } : emptyFn;
    }());
    var log = emptyFn;
     ...
     * values to strings. Custom dimensions param is optional, must be between 1-4 in size. Values that are null, empty strings, 
     * or beyond 4th element will be ignored. Customer value increases (CLV) are optional. It's highly recommended that the 
    ...
    ref._upload = function () {
      if (uploadTime != null) {
        if ((generateClientTimeInMillis() - uploadTime) < uploadTimeout) {
